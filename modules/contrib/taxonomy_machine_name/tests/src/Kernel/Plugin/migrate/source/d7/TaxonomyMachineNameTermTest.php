...
namespace Drupal\Tests\taxonomy_machine_name\Kernel\Plugin\migrate\source\d7;
 ...
 *
 * @covers \Drupal\taxonomy_machine_name\Plugin\migrate\source\d7\TaxonomyMachineNameTerm
 * @group taxonomy_machine_name
 */
class TaxonomyMachineNameTermTest extends MigrateSqlSourceTestBase {
  ...
  public function providerSource() {
    ...
    $tests[0]['expected_data'] = [
      [
        ...
        'language' => 'en',
        'machine_name' => 'tags',
        'term_machine_name' => 'name_value_1',
      ...
      [
        ...
        'language' => 'en',
        'machine_name' => 'categories',
        'term_machine_name' => 'name_value_2',
      ...
      [
        ...
        'language' => 'en',
        'machine_name' => 'categories',
        'term_machine_name' => 'name_value_3',
        'vocabulary_machine_name' => 'categories',
      ],
      [
        'tid' => 4,
        ...
        'language' => 'en',
        'machine_name' => 'tags',
        'term_machine_name' => 'name_value_4',
        'vocabulary_machine_name' => 'tags',
      ],
      [
        'tid' => 5,
        ...
        'language' => 'en',
        'machine_name' => 'categories',
        'term_machine_name' => 'name_value_5',
        'vocabulary_machine_name' => 'categories',
      ],
      [
        'tid' => 6,
        ...
        'language' => 'en',
        'machine_name' => 'categories',
        'term_machine_name' => 'name_value_6',
        'vocabulary_machine_name' => 'categories',
      ],
      [
        'tid' => 7,
        ...
        'language' => 'en',
        'machine_name' => '',
        'term_machine_name' => 'name_value_7',
